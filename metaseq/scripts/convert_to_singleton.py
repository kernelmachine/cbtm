...
def create_generation_config_with_defaults(model_path):
    files = glob.glob(f"{model_path}/checkpoint*.pt")

    MP = len(files)
    BPE_MERGES = "/checkpoint/suching/data/opt/120321/tokenizers/" + "/gpt2-merges.txt"
    BPE_VOCAB = "/checkpoint/suching/data/opt/120321/tokenizers/" + "/gpt2-vocab.json"
