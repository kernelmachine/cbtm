...
@dataclass
class StreamingInstructionFinetuneLanguageModelingConfig(StreamingLanguageModelingConfig):
...
@register_task(
    "streaming_instruction_finetune_language_modeling",
    dataclass=StreamingInstructionFinetuneLanguageModelingConfig,
)
class StreamingInstructionFinetuneLanguageModelingTask(StreamingLanguageModelingTask):
    """
